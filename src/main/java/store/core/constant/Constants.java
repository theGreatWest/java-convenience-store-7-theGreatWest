...
public class Constants {
    ...
    public static final String ADDITIONAL_FOR_FREE_ITEM_YES_NO = "를 더 구매하면 1개를 무료로 더 받을 수 있습니다. 추가하시겠습니까? (Y/N)";
    public static final String FREE_ITEM_GUIDE_YES_NO = "를 무료로 더 받을 수 있습니다. 추가하시겠습니까? (Y/N)";
    public static final String PURCHASE_WITHOUT_DISCOUNT_YES_NO = "프로모션 할인이 적용되지 않습니다. 그래도 구매하시겠습니까? (Y/N)";

    public static final String RECEIPT_STORE_NAME = "===========W 편의점=============";
    public static final String RECEIPT_HEAD = "상품명\t\t수량\t금액";
